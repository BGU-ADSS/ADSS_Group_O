        ...
        while (true) {
            ...
            if (input == 1) {
                ...
                if (kind.equals("neither")) {
                    ...
                    productService.setFatherCategory(productService.getCategoryByName(name1).getCategoryID(),productService.getCategoryByName(father).getCategoryID());
...
//                    }
            ...
            if (input == 3) {
                ...
                System.out.println("Enter Product name: ");
                String name = reader.readLine();
                System.out.println(productService.buildItem(productService.getProductIDByName(name), date, true));
            }
            if (input == 4) {
                System.out.println("Enter Product name: ");
                String name = reader.readLine();
            ...
            if (input == 9) {System.out.println("Enter category name: ");
                String name = reader.readLine();
            ...
            if (input == 12) {
                ...
                System.out.println(purchaseService.calculateTotal(purchaseService.getPurchaseIDByCustomerAndDate(id, purchaseDate)));
            }
            if (input == 13) {
                System.out.println("Enter category name: ");
                String name = reader.readLine();
            ...
            if (input == 16) {
                ...
                System.out.println(purchaseService.addItem(purchaseService.getPurchaseIDByCustomerAndDate(id, purchaseDate), productService.getProductIDByName(pname)));
            }
            if (input == 17) {
                System.out.println("Enter purchase date: ");
                String pd = reader.readLine();
